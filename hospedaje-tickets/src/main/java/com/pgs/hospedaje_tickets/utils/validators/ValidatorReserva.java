...
public class ValidatorReserva {
    ...
    public void validateReserva(ReservaDTO dto){
        if (dto.getId_hospedaje() == null ||dto.getId_hospedaje() <=0){
