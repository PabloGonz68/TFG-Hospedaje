...
const NotFoundPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#ffcd40] flex items-center justify-center p-4">
            <div className="max-w-2xl mx-auto text-center">
                {/* Ilustración 404 */}
                <div className="mb-8">
                    <div className="relative">
                        {/* Número 404 grande */}
                        <div className="text-[12rem] md:text-[16rem] font-black text-[#1d1d1b]/20 leading-none select-none">
                            404
                        </div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="relative">
                                <div className="w-24 h-24 bg-[#1d1d1b] rounded-full flex items-center justify-center animate-bounce">
                                    <Compass className="w-12 h-12 text-[#ffcd40]" />
                                </div>
                                ...
                                <div className="absolute -top-4 -left-8 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-lg animate-pulse">
                                    <MapPin className="w-4 h-4 text-[#1d1d1b]" />
                                </div>
                                ...
                                <div className="absolute -bottom-4 -right-8 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-lg animate-pulse delay-300">
                                    <Home className="w-4 h-4 text-[#1d1d1b]" />
                                </div>
                                ...
                                <div className="absolute top-8 -right-12 w-6 h-6 bg-white rounded-full flex items-center justify-center shadow-lg animate-pulse delay-500">
                                    <Search className="w-3 h-3 text-[#1d1d1b]" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/* Contenido principal */}
                <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12 border border-[#1d1d1b]/10">
                    <h1 className="text-4xl md:text-5xl font-bold text-[#1d1d1b] mb-4">¡Ups! Te has perdido</h1>

                    <p className="text-xl text-[#1d1d1b]/80 mb-2">La página que buscas no existe</p>

                    <p className="text-[#1d1d1b]/60 mb-8 max-w-md mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <button
                            ...
                            className="flex items-center gap-2 bg-[#1d1d1b] hover:bg-[#2d2d2b] text-white px-8 py-4 rounded-xl font-bold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 border-2 border-[#1d1d1b] text-[#1d1d1b] hover:bg-[#1d1d1b] hover:text-white px-8 py-4 rounded-xl font-bold transition-all duration-200"
                        >
                ...
                <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <button
                        ...
                        className="bg-white/80 hover:bg-white text-[#1d1d1b] p-4 rounded-xl transition-all duration-200 hover:shadow-lg group"
                    >
                ...
                <div className="mt-8 text-[#1d1d1b]/60">
